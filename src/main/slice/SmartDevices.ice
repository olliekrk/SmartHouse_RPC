...
// inteligentny dom
// czujniki temp, lodówki, piece, monitoring z opcją pan/tilt/zoom

// dziedziczenie interfejsow IDL jesli jest to uzasadnione
//

// np. wyjatki
// urzadzenia jako osobne obiekty middleware, do ktorych dostep jest po podaniu ID
// instancjonowanie obiektow powinno byc dopiero po pierwszym odwolaniu do niego
